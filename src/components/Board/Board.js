...
const board = (props) => {
    ...
    if (props.gameStatus > 10 && props.gameStatus <= 59) {
        leftDiceArea = props.p1IsNext ? <DiceArea dice={props.dice} clicked={props.rollDice} gameStatus={props.gameStatus} handlePlayerNoMoves={props.handlePlayerNoMoves}/> : '';
        rigthDiceArea = props.showComputerDice ? <DiceArea dice={props.dice} clicked={props.rollDice} gameStatus={props.gameStatus} /> : '';
